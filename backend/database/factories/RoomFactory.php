...
class RoomFactory extends Factory
{
    private const ROOM_TYPES = [
        ...
        ['type' => 'Aile OdasÄ±', 'capacity' => 4, 'rate' => 2800],
        ['type' => 'Suite', 'capacity' => 4, 'rate' => 3600],
        ['type' => 'King Suite', 'capacity' => 5, 'rate' => 5500],
    ];

    private const AMENITY_POOL = ['Deniz ManzarasÄ±', 'Balkon', 'Klima', 'Mini Bar', 'Jakuzi', 'Wi-Fi', 'Kasa', 'Oda Servisi'];
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            // status=passive (see 2026_09_01_090301_modify_rooms_status_add_passive) â€”
